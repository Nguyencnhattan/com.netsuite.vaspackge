define(["require", "exports", "N/record", "N/currentRecord", "./constants.fieldid", "./constants.helper"], function (require, exports, record, currentRecord, constants_fieldid_1, constants_helper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.bodyHTML = exports.mergeHTML = void 0;
    const mergeHTML = () => {
        let html = `
...
`;
    ...
    const bodyHTML = (customReportId) => {
        ...
        <table id="report-result" style="table-layout: fixed; width: 100%; border-spacing: 0px; border-collapse: separate;">
            <tr>
                <td colspan="2" style="vertical-align: top; overflow-x: scroll; border: 1.5px solid #000; padding: 1rem;">
                    ...
                    <p><b>Mẫu số ${reportRecord.getValue({ fieldId: constants_fieldid_1.VAS_DEFINE.REPORT_PATTERN.FIELD_ID })} </b></p>
                    <p>${reportRecord.getValue({ fieldId: constants_fieldid_1.VAS_DEFINE.REPORT_CIRCULAR.FIELD_ID })}</p>
                    </div>
                </div>
                        <div id="report-title" style="max-width: 400px; place-self: center;">
                            <h1 id="report-title-text" class="text-center" style="text-transform: uppercase">${reportRecord.getValue({ fieldId: constants_fieldid_1.VAS_DEFINE.REPORT_TITLE.FIELD_ID })}</h1>
                            <p id="report-sub-title" class="text-center">${reportRecord.getValue({ fieldId: constants_fieldid_1.VAS_DEFINE.REPORT_SUB_TITLE.FIELD_ID })}</p>`;
        if ((0, constants_helper_1.checkNotNull)(fromDate) && (0, constants_helper_1.checkNotNull)(toDate)) {
        ...
        else if (!(0, constants_helper_1.checkNotNull)(fromDate) && (0, constants_helper_1.checkNotNull)(toDate)) {
